...
param_trainset_pickle_file_path = os.path.join(os.path.dirname(__file__), '../data_provider_farm/data_folder/data_list_brainwash_train.pkl')
...
param_net_input_height = 256

# input width for network
param_net_input_width = 256
...
param_feature_map_size_list = [63, 31, 15, 7]
